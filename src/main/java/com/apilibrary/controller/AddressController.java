...
public class AddressController {
	...
	@GetMapping("/address/account/delivery/all/{id}")
	public ResponseEntity<Object> getAllAddressDelivery(@PathVariable int id) throws NotFoundException {
		List<Address> address = serviceAddress.getAllAddressDelivery(id);
